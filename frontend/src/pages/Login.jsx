          ...
          <div className="mt-6">
            ...
            <div>
              <div className='flex justify-center text-center m-auto'>
                <a
                  href="#"
                  className="w-full inline-flex justify-center  m-auto py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
                >
                  <span className="fill-sky-600">Sign in with GitHub</span>
